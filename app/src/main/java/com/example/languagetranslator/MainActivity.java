...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sourceText =(TextInputEditText) findViewById(R.id.idEdtSource);
        micIV =(ImageView) findViewById(R.id.idIVMic);
        translateTV =(TextView) findViewById(R.id.idTVTranslatedTV);
        translatebtn =(MaterialButton) findViewById(R.id.idBtnTranslate);
